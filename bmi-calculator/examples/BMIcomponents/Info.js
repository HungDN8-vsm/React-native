...
export default function Info({ weight, setWeight, age, setAge }) {
  const minusWeight = () => {
  ...
  const onMinusWeightPressIn = () => {
    minusWeight();
    this.timer = setTimeout(onMinusWeightPressIn, 150);
  };

  const onPlusWeightPressIn = () => {
    plusWeight();
    this.timer = setTimeout(onPlusWeightPressIn, 150);
  };

  const onMinusAgePressIn = () => {
    minusAge();
    this.timer = setTimeout(onMinusAgePressIn, 150);
  };

  const onPlusAgePressIn = () => {
    plusAge();
    this.timer = setTimeout(onPlusAgePressIn, 150);
  };
